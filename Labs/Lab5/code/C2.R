...
# na tabela ds, onde F107 é maior que 0, ordena pela coluna IFID, e cria uma coluna "id", onde estas 
# têm o valor da linha 
...
# aplicação da função fx.self2 nos dados guardados na lista
